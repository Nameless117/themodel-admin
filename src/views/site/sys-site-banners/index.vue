            ...
            <el-card class="box-card">
                ...
                <el-dialog :title="title" :visible.sync="open" width="500px">
                    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                                    ...
                                    <el-form-item label="banner类型：首页/有声读物" prop="type">
                                        <el-input v-model="form.type" placeholder="banner类型：首页/有声读物"
                                                      />
                                    </el-form-item>
                                    <el-form-item label="banner描述" prop="description">
                                        <el-input v-model="form.description" placeholder="banner描述"
                                                      />
                                    </el-form-item>
                                    <el-form-item label="二级描述（用于有声读物）" prop="subDescription">
                                        <el-input v-model="form.subDescription" placeholder="二级描述（用于有声读物）"
                                                      />
                                    </el-form-item>
                                    <el-form-item label="PDF标题" prop="pdfTitle">
                                        <el-input v-model="form.pdfTitle" placeholder="PDF标题"
                                                      />
                                    </el-form-item>
                                    <el-form-item label="PDF下载链接" prop="pdfUrl">
                                        <el-input v-model="form.pdfUrl" placeholder="PDF下载链接"
                                                      />
                                    </el-form-item>
                    </el-form>
